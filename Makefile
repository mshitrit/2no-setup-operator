...
OPERATOR_NAME ?= tno-setup-operator
...
# 2no.io/tno-setup-operator-bundle:$VERSION and 2no.io/tno-setup-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= 2no.io/tno-setup-operator
...
.PHONY: full-gen
full-gen:  tidy vendor generate manifests bundle fix-imports  ## generates all automatically generated content
